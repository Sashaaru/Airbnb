...
st.set_page_config(page_title="AirBnb-Analysis by Ramesh!!!", page_icon=":rainbow:", layout="wide")

st.title(":volcano:   AirBnb-Analysis")
...
SELECT = option_menu(
    ...
    default_index=0,  # Change the default index to 0 for "Home"
...
if SELECT == "Explore Data":
 ...
 if fl is not None:
    ...
    os.chdir(r"C:\\Users\\rameshr\\PycharmProjects\\Airbnb")
